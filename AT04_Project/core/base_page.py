...
class BasePage:
    ...
    def _verify_value_on_text(self, locator: str, text: str):
    ...
    def _verify_placeholder(self, locator: str, text: str):
        """Verify that the expected placeholder is displayed."""
    ...
    def _select_menu(self, text: str):
        ...
        locator = "//span[normalize-space()={text}]"
        self._click(locator)    
    ...
    def _take_screenshot(self, filename: str):
        ...
        print(f"[SCREENSHOT] Save at: {path_file}")    

    def _verify_locator_visible(self, locator: str):
        """Verify that the position exists on the form."""
        expect(self.page.locator(locator)).to_be_visible()
        print(f"[ASSERT]{locator} is displayed successfully!")
    ...
    def _scroll_to_view(self, locator: str):
        """Scroll to view locator"""
